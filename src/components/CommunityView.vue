        ...
        <div class="community-box">
          ...
          <div class="community-main">
            <ul class="community-list data-info">
              ...
              <li v-for="(item,index) in erumData" :key="index">
        ...
        <div class="community-box">
          ...
          <div class="community-main">
            <ul class="community-list data-news">
              ...
              <li v-for="(item,index) in policyData" :key="index">
                <a :href="item.link">{{item.title}}</a>
                <span>{{item.date}}</span>
              </li>
...
export default {
  setup(){
    ...
    const erumData = computed(()=>store.getters.erumData);
    const policyData = computed(()=>store.getters.policyData);
